...
\href{mailto:nikgvetr@stanford.edu}{nikgvetr@stanford.edu} --- \href{https://www.github.com/NikVetr/}{github.com/NikVetr} --- \href{https://www.linkedin.com/in/nikolai-vetr}{linkedin.com/in/nikolai-vetr} --- \href{https://vetr.dev/}{vetr.dev}\\
...
\textbf{Postdoc}, Montgomery \& Wheeler Labs, Stanford University\hfill\emph{Current}\\
Pathology + Biomedical Data Science
\vspace{-0.25em}

\textbf{PhD}, University of California, Davis\hfill\emph{2021}\\
...
\textbf{Workshops}\hfill\emph{2013 - Present}\\
...
\textbf{Discussion Groups}\hfill\emph{2013 - Present}\\
I've actively participated in groups on Computational Molecular Evolution, Paleoanthropology, Quantitative Genetics, Bio-AI Integration, and Machine Learning. I've founded and lead groups on Python, Applied Linear Algebra, Bayesian Data Analysis, and Deep Learning
...
My postdoctoral work in the Montgomery and Wheeler Labs focuses on exploring and developing statistical methods to better understand the molecular mechanisms by which genetic and environmental variation structure phenotypic variation, with an eye to translational applications in contexts such as drug discovery and personalized medicine. I've lately endeavored to port some of these scientific research and publication utilities to static web formats to improve their accessibility and value to the scientific public (eg \href{https://vetr.dev/layout-gui/}{1}, \href{https://vetr.dev/color-optimization/}{2}). Current and recent projects include:

\begin{itemize}[noitemsep]

\item Developing a flexible \textbf{sum-to-zero tensor (S2Z) parameterization with elliptical family marginals} for broad and varied applications, including sparsity models of contingency tensors but extending to fully general multilevel models. Deriving and implementing forward and back-transforms for the multilevel models allows us to exactly recover "population" model parameters at substantially reduced (in some cases, multiple orders of magnitude) computational cost [\href{https://github.com/spinkney/flexible-sum-to-zero/tree/main}{LINK}]

\item Performing \textbf{multi-tissue, multi-omic, analysis and integration of acute exercise response} across multiple exercise modalities and training states, as co-lead of the ``highly-active'' multiomic landscape paper through the MoTrPAC Consortium, as well as other papers in that package [WiP]
...
%\item Developing and implementing a \textbf{dynamic request intake framework} atop Google Workspace with Google Apps Script to assist administrative staff with coordinating disparate requests with scaling group size
...
\item \textbf{Vetr, N.*}, Pinkney, S., Montgomery, S., et al.  2026.  \emph{Population Effect Estimation in Bayesian Hierarchical Models using Sum-to-Zero Constraints}. In Prep. [\href{https://www.overleaf.com/project/680983e5256009dab403bb20}{LINK}]

\item \textbf{MoTrPAC Study Group}.  2026.  \emph{Multi-Omic, Multi-Tissue Responses to Acute Exercise in Sedentary Adults: Findings from the Molecular Transducers of Physical Activity Consortium (MoTrPAC)}.  In review at Cell.

\item \textbf{Vetr, N.*}, Abell, N.,  Montgomery, S., et al.  2026.  \emph{A Survey of High Depth Allele-Specific Expression Across Normal Tissues and Ovarian Cancers}.  In Prep. [\href{https://www.overleaf.com/project/65a727708459508b76126eae}{LINK}]
...
\item \textbf{Vetr, N.G}., Montalvo S., et al. 2026. \emph{Prediction of Cardiorespiratory Fitness from Multi-Omic Profiles}. Submitted to ACSM 2026.
