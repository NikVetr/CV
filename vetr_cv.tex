...
\subsection{Journal Article Review\hspace{4cm}Grant Review}


\emph{Evolution} (2017), \emph{Cell Reports} (2021),  \hspace{3.15cm}\emph{WAI Grants} (2021, 2022)
\\
...
\item \textbf{Vetr, N}., Gay, N., and S. Montgomery. 2022.  \emph{The impact of exercise on gene regulation in association with complex trait genetics}. In prep for Nature Genetics.

\item MoTrPAC Study Group. 2022.  \emph{Temporal dynamics of the multi-omic response to endurance exercise training across tissues}. In prep for Nature.
